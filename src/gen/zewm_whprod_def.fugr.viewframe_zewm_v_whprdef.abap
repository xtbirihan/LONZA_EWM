*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEWM_V_WHPRDEF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEWM_V_WHPRDEF      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEWM_V_WHPRDEF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEWM_V_WHPRDEF_EXTRACT
TOTAL = ZEWM_V_WHPRDEF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEWM_V_WHPRDEF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEWM_V_WHPRDEF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEWM_V_WHPRDEF_EXTRACT
TOTAL = ZEWM_V_WHPRDEF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEWM_V_WHPRDEF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEWM_V_WHPRDEF'
...
TOTAL = ZEWM_V_WHPRDEF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEWM_V_WHPRDEF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEWM_V_WHPRDEF-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEWM_V_WHPRDEF'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEWM_V_WHPRDEF-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEWM_V_WHPRDEF_EXTRACT
TOTAL = ZEWM_V_WHPRDEF_TOTAL
