FUNCTION z_vi02_rf_dmy_tr_lgpla_valid.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* Name:         Z_VI02_RF_DMY_TR_LGPLA_VALID
* Description:  verify Storage Bin
*
*----------------------------------------------------------------------*
*
...
*----------------------------------------------------------------------*
  ...
  zcl_vi02_rf_dummy_transport=>get_inst( )->valid_lgpla( EXPORTING  is_valid_prf        = is_valid_prf
