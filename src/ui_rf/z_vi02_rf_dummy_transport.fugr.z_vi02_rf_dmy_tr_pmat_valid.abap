FUNCTION z_vi02_rf_dmy_tr_pmat_valid.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* Name:         Z_VI02_RF_DMY_TR_PMAT_VALID
* Description:  verify Pack Material
*
*----------------------------------------------------------------------*
*
...
*----------------------------------------------------------------------*
  ...
  zcl_vi02_rf_dummy_transport=>get_inst( )->valid_pmat(  EXPORTING  is_valid_prf        = is_valid_prf
