*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_Z_VI02_V_SMPPOST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_Z_VI02_V_SMPPOST    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_Z_VI02_V_SMPPOST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = Z_VI02_V_SMPPOST_EXTRACT
TOTAL = Z_VI02_V_SMPPOST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_Z_VI02_V_SMPPOST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_Z_VI02_V_SMPPOST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = Z_VI02_V_SMPPOST_EXTRACT
TOTAL = Z_VI02_V_SMPPOST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_Z_VI02_V_SMPPOST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_Z_VI02_V_SMPPOST'
...
TOTAL = Z_VI02_V_SMPPOST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_Z_VI02_V_SMPPOST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_Z_VI02_V_SMPPOST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_Z_VI02_V_SMPPOST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_Z_VI02_V_SMPPOST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = Z_VI02_V_SMPPOST_EXTRACT
TOTAL = Z_VI02_V_SMPPOST_TOTAL
