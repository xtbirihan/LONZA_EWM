interface ZIF_Z_VI02_GM_CREATE_READ
  public .
  ...
  types:
    begin of ZZS_VI02_HU_HEADER,
      ...
      VGUID_HU type /SCWM/GUID_HU,
      VHUIDENT type /SCWM/DE_HUIDENT,
      VPMAT_GUID type /SCWM/DE_MATID,
      VPMAT type /SCWM/DE_PMAT,
      VPMTEXT type /SCWM/DE_PMAT_DESC,
      VLETYP type /SCWM/DE_HUTYP,
